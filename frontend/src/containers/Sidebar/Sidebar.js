...
const options = [
	{
		key: 'home-page',
		label: 'sidebar.homePageManagement',
		leftIcon: 'ion-android-home',
	},
	{
		key: 'about-me',
		label: 'sidebar.aboutMeManagement',
		leftIcon: 'ion-person',
	},
	{
		key: 'posts',
		label: 'sidebar.postManagement',
		leftIcon: 'ion-compose',
	},
	{
		key: 'galleries',
		label: 'sidebar.galleryManagement',
		leftIcon: 'ion-images',
	},
	{
		key: 'orders',
		label: 'sidebar.orderManagement',
		leftIcon: 'ion-android-cart',
	},
	// {
	// 	key: 'contacts',
	// 	label: 'sidebar.contactManagement',
	// 	leftIcon: 'ion-android-person-add',
	// },
	// {
	// 	key: 'subscribers',
	// 	label: 'sidebar.subscriberManagement',
