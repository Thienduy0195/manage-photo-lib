...
const routes = [
	...
	{
		path: 'posts/create',
		component: lazy(() => import('@iso/containers/Posts/CreatePost')),
	},
	{
		path: 'posts/:postId',
		component: lazy(() => import('@iso/containers/Posts/SinglePost')),
	},
	{
		path: 'posts',
		component: lazy(() => import('@iso/containers/Posts/Posts')),
	},
	{
		path: 'home-page',
	...
	{
		path: 'about-me',
		component: lazy(() => import('@iso/containers/AboutMe/AboutMe')),
	},
	{
		path: 'galleries/create',
		component: lazy(() => import('@iso/containers/Galleries/CreatePost')),
	},
	{
		path: 'galleries/:galleryId',
		component: lazy(() => import('@iso/containers/Galleries/SinglePost')),
	},
	{
		path: 'galleries',
		component: lazy(() => import('@iso/containers/Galleries/Galleries')),
	},
	{
		path: 'orders/:orderId',
